...
## Why not write an entire server all in one function or a file?
...
![File Structure](public/assets/mvc-files.png)
...
![MVC Flow Diagram](public/assets/mvc_flow_diagram.png)
...
![MVC Flow](public/assets/mvc_flow.png)
